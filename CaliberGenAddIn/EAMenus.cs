...
namespace EAAddIn
{
    ...
    public class GetCurrentPath: IEAMenu
    {
        ...
        public string Name
        {
            get { return AddInApplications.UIGetCurrentPath; }
        }
