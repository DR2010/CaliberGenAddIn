...
namespace EAAddIn.Applications.AuditConverter.AuditUpdate
{
    ...
    public partial class Audit : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Name = "audit_header_id", Storage = "_Audit_header_id", DbType = "Int NOT NULL")]
        ...
        [global::System.Data.Linq.Mapping.AssociationAttribute(Name = "FK_auditdetail_audit", Storage = "_Auditdetail", ThisKey = "Audit_id", OtherKey = "Audit_id", DeleteRule = "NO ACTION")]
    ...
    public partial class Auditdetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Name = "audit_id", Storage = "_Audit_id", DbType = "Int NOT NULL")]
        public int Audit_id
        {
            get
            {
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Name = "audit_detail_id", Storage = "_Audit_detail_id", AutoSync = AutoSync.OnInsert, DbType = "Int NOT NULL IDENTITY", IsPrimaryKey = true, IsDbGenerated = true)]
        ...
        [global::System.Data.Linq.Mapping.AssociationAttribute(Name = "FK_auditdetail_audit", Storage = "_Audit", ThisKey = "Audit_id", OtherKey = "Audit_id", IsForeignKey = true)]
        public Audit Audit
        {
            get
            {
    ...
    public partial class Auditheader : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private System.Nullable<System.DateTime> _ArchivedUpTo;
        ...
        partial void OnArchivedUpToChanging(System.Nullable<System.DateTime> value);
        partial void OnArchivedUpToChanged();
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_ArchivedUpTo", DbType = "DateTime")]
        public System.Nullable<System.DateTime> ArchivedUpTo
        {
            get
            {
                return this._ArchivedUpTo;
            }
            set
            {
                if ((this._ArchivedUpTo != value))
                {
                    this.OnArchivedUpToChanging(value);
                    this.SendPropertyChanging();
                    this._ArchivedUpTo = value;
                    this.SendPropertyChanged("ArchivedUpTo");
                    this.OnArchivedUpToChanged();
                }
            }
        }
